function [q1,s1,l1,q1d,s1d]=rk4(Func,h,flow,t0,q0,p0,u0,s0,l0)
% [flow,t1,q1,p0,u0,s1,l1]=rk4(Func,h,flow,t0,q0,p0,u0,s0,l0)
...
% a ODE flow <Func> by giving flow mode <flow>, dt <h>,
